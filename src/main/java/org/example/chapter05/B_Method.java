...
// +) 구현부
// : 반환 타입이 void가 아닐 경우 반드시 'return 반환 타입 데이터;'
...
public class B_Method {
    public static void main(String[] args) {
        ...
        // 2. 인자(인수)
        // - 메서드를 호출할 때 소괄호 안에 전달도는 '값'
        // - 실제 데이터를 전달 역할
        // >> 메서드 호출부에서 전달하여 매개 변수에 저장

        // example.add(1); // 2개으 인수가 필요하지만 1이 발견되었습니다
        // example.add(1, 2, 3); // 2개의 인수가 필요하지만 3이 발견되었습니다
        // >> 인자값의 매개변수의 수는 같아야 한다
