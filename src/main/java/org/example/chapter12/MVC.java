...
*       >> View와 Controller의 세부 구현 사항으로부터 독립적
*
* 2. View(뷰)
*       : 사용자에게 데이터를 표시하는 방법을 정의
*       - Model의 정보를 표시, 사용자 액션을 Controller 에게 전달하는 역할
*       - Model이 가진 정보를 사용자가 이해할 수 있는 형태로 변환
*
* 3. Controller(컨트롤러)
*       : 사용자의 입력을 처리하고, Model과 View 사이의 상호 작용을 관리
...
// Controller(컨트롤러): 영양사 선생님 - 급식표 내용을 업데이트하고, 칠판에 알려 주는 역할
