...
class Singleton {
    ...
    public static Singleton getInstance() {
        ...
        // : 반환 타입은 클래스 타입
        if (instance == null) {
            // 필드의 초기화 이전 >> 아직 인스턴스화 X
            instance = new Singleton(); // 인스턴스 진행
        }

        return instance;
        // 1) if 조건문 = true: 인스턴스화 된 객체를 반환
        // 2) if 조건문 = false: 기존의 필드에 저장된 객체를 반환
...
public class D_Singleton {
    public static void main(String[] args) {
        ...
        // org.example.chapter13.SchoolPrincipal@119d7047
        ...
        System.out.println(example1); // org.example.chapter13.Example@4eec7777
        System.out.println(example2); // org.example.chapter13.Example@3b07d329
        System.out.println(example3); // org.example.chapter13.Example@41629346
        System.out.println(example4); // org.example.chapter13.Example@404b9385
