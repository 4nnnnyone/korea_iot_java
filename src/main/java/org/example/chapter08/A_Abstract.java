...
// cf) 다중 상속이 불가능 - 하나의 extends만 가능

// 5. 추상 메서드
// : 메서드의 선언부만 존재 O, 구현부가 없는 메서드
// - 자식 클래스에서 해당 메서드를 반드시 구현하도록 강제하는 역할
// - abstract 키워드 사용 + 구형부 {} 대신 세미콜론;을 사용하여 선언 마침

// cf) 메서드 구성: 선언부(시그니처) + 구현부 {}
// [접근 제어자] 반환 타입 메서드명(매개 변수 나열...) { 구현부 - 메서드의 기능 동작 }
...
class Police extends Human {
    ...
    @Override
    void work() { // 추상 메서드 구현
        System.out.println("경찰은 치안 유지 업무를 담당합니다.");
    }
}
